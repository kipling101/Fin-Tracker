...
from tkinter import messagebox; from tkinter import Entry; from tkinter import ttk; from tkinter import tix; from tkinter.tix import Balloon
import matplotlib
...
def openCashForm(userID):
    ...
    def cashRemove(userID, removeName, removeAmount, removeAPR):
        try:
            ...
            if userID == "" or removeName == "" or removeAmount == "" or removeAPR == "":
                ...
                return
            if removeAmount.replace(".", "").isnumeric() and removeAPR.replace(".", "").isnumeric():
    ...
    try:
        ...
        helpObject.bind_widget(addCashName, balloonmsg="Name of the transaction.")
        helpObject.bind_widget(addCashAmount, balloonmsg="Value of the transaction on the day it was entered, in £.")
        helpObject.bind_widget(addCashDate, balloonmsg="Date of the transaction. Format: YYYY-MM-DD")
        helpObject.bind_widget(addCashAPR, balloonmsg="Annual Percentage Rate of the transaction, do not include the % sign.")
        ...
        helpObject.bind_widget(removeCashName, balloonmsg="Name of the transaction.")
        helpObject.bind_widget(removeCashAmount, balloonmsg="Value of the transaction on the day it was entered, in £.")
        helpObject.bind_widget(removeCashAPR, balloonmsg="Annual Percentage Rate of the transaction, do not include the % sign.")
        helpObject.bind_widget(removeCashButton, balloonmsg="Press to remove the transaction from the cash table.")

        main.mainloop()

    except ValueError:
        tk.messagebox.showerror(title="Error", message="Error: Invalid Date.")
    except Exception as e:
