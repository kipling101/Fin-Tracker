...
def getUserPrivileges(userID):
    ...
    tk.showerror(title="Modify Permissions",message="Error fetching permissions, please try again later.")
...
modifyButton = tk.Button(main, text="Modify", font="Helvetica 12", command=lambda: permModify(userIDEntry.get(), [var1.get(), var2.get(), var3.get(), var4.get(), var5.get()]))
...
openAccountCreatorButton = tk.Button(main, text="Create Account", font="Helvetica 12", command=openAccountCreator)
